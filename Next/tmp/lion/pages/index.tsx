...
const MainIntroLayout = styled.div<MainIntroLayoutProps>`
  ...
  &::before {
    ...
    background-size: cover;
    background-position: center;
    filter: ${({ showHiddenContent }) =>
      showHiddenContent ? "none" : "blur(5px)"};
...
export default function Home(): JSX.Element {
  ...
  return (
    <>
      ...
      <MainSmallContent>
        어렵고 멀게만 느껴진 모든것들,<br></br>
        누구나 쉽게 접하고, 다양한 방안들을 확인 가능하게 하는것이
        Solver커뮤니티의 존재 이유입니다.
      </MainSmallContent>
      <MainIntroRow>
        <MainIntroLayout
          imageUrl="main1.png"
          showHiddenContent={showHiddenContent}
          onMouseEnter={toggleHiddenContent}
          onMouseLeave={toggleHiddenContent}
        >
          {showHiddenContent ? (
            <MainIntroContent>
        ...
        <MainIntroLayout
          imageUrl="main2.png"
          showHiddenContent={showHiddenContent2}
          onMouseEnter={toggleHiddenContent2}
          onMouseLeave={toggleHiddenContent2}
        >
          {showHiddenContent2 ? (
            <MainIntroContent>
              <MainIntroTitle>
      ...
      <MainIntroRow>
        <MainIntroLayout
          imageUrl="main3.png"
          showHiddenContent={showHiddenContent3}
          onMouseEnter={toggleHiddenContent3}
          onMouseLeave={toggleHiddenContent3}
        >
          {showHiddenContent3 ? (
            <MainIntroContent>
              <MainIntroTitle>Solver가 바꿀 커뮤니티</MainIntroTitle>
        ...
        <MainIntroLayout
          imageUrl="main1.png"
          showHiddenContent={showHiddenContent4}
          onMouseEnter={toggleHiddenContent4}
          onMouseLeave={toggleHiddenContent4}
        >
          {showHiddenContent4 ? (
            <MainIntroContent>
              <MainIntroTitle>
      ...
      <SectionContainer>
        <NoticeLayout>
          ...
          <NoticeButton onClick={() => onClickNoticeItem("/Notice")}>
            +
          </NoticeButton>
        </NoticeLayout>
        ...
        <ListContainer>
          ...
          <ListItem onClick={() => onClickNoticeItem("/Notice")}>
            ...
            <ItemDescription>
              주요 업데이트 및 변경 사항을 안내합니다.
            </ItemDescription>
          </ListItem>
          <ListItem onClick={() => onClickNoticeItem("/Notice")}>
            <ItemTitle>공지사항 3</ItemTitle>
            <ItemDescription>
              서비스 이용 안내 및 업데이트 예정 사항입니다.
            </ItemDescription>
          </ListItem>
          <ListItem onClick={() => onClickNoticeItem("/Notice")}>
            <ItemTitle>공지사항 1</ItemTitle>
      ...
      <SectionContainer>
        <NoticeLayout>
          ...
          <NoticeButton onClick={() => onClickNoticeItem("/Resource")}>
            +
          </NoticeButton>
        </NoticeLayout>
        <ListContainer>
